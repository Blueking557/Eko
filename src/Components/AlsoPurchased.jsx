function AlsoPurchased() {
  return (
    <section
      id="products"
      className="m-4 md:m-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center overflow-x-hidden"
    >
      {/* LEFT: IMAGE */}
      ...
      <div className="flex flex-col p-6 md:p-10 space-y-4 md:space-y-6 justify-center">
        ...
        <button className="mt-4 w-fit rounded-full border-2 border-blue-600 px-6 py-3 text-blue-600 font-medium hover:bg-blue-600 hover:text-white transition whitespace-nowrap">
          Explore More
        </button>
      </div>
    </section>
